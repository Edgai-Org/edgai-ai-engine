 ...
 *
 * Requires a GGUF model in EDGAI_MODELS_DIR, /usr/share/edgai/models/, or ~/.edgai/models/.
...
int main(void)
{
    ...
    if (!session->llm_model) {
        ...
        printf("  Download a GGUF model and set EDGAI_MODELS_DIR to run this test.\n");
